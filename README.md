# Perfect Request Logging Example
...
An Example Request Logger for Perfect
...
* Open `PerfectRequestLogging.xcodeproj`
...
* Execute `swift build`
* Once the project has compiled, execute `./.build/debug/PerfectRequestLogging`
